...
SpellInfo = {
  ['Default'] = {
    ...
    -- newest tibia spells
    --// Fixed summon familiar wrong vocation ids.
    ...
    ["Nature's Embrace"] =         {id = 163, words = 'exura gran sio',        exhaustion = 60000, premium = true,  type = 'Instant', icon = 'naturesembrace',         mana = 400,    level = 300,soul = 0, group = {[2] = 1000},               vocations = {2, 6}},
    ...
    --// Added missing "exana vita" spell.
    ['Cancel Magic Shield'] =      {id = 164, words = 'exana vita',            exhaustion = 2000,  premium = true,  type = 'Instant', icon = 'cancelmagicshield',      mana = 50,    level = 300, soul = 0, group = {[1] = 2000},               vocations = {1, 2, 5, 6}},
    --// New Spells from Winter Update 2022
    ['Great Death Beam'] =         {id = 165, words = 'exevo max mort',        exhaustion = 8000, premium = true,   type = 'Instant', icon = 'greatdeathbeam',         mana = 140,   level = 130, soul = 0, group = {[1] = 2000},               vocations = {1, 5}},
    ['Ice Burst'] =                {id = 166, words = 'exevo ulus frigo',      exhaustion = 18000, premium = true,  type = 'Instant', icon = 'iceburst',               mana = 230,   level = 300, soul = 0, group = {[1] = 2000},               vocations = {2, 6}},
	  ['Earth Burst'] =              {id = 167, words = 'exevo ulus tera',       exhaustion = 18000, premium = true,  type = 'Instant', icon = 'earthburst',             mana = 230,   level = 300, soul = 0, group = {[1] = 2000},               vocations = {2, 6}},
    ["Executioner's Throw"] =      {id = 168, words = 'exori amp kor',         exhaustion = 12000, premium = true,  type = 'Instant', icon = 'executionersthrow',      mana = 225,   level = 300, soul = 0, group = {[1] = 2000},               vocations = {4, 8}},
    ['Divine Granade'] =           {id = 169, words = 'exevo tempo mas san',   exhaustion = 12000, premium = true,  type = 'Instant', icon = 'divinegranade',          mana = 160,   level = 150, soul = 0, group = {[1] = 2000},               vocations = {3, 7}},
  }
  --[[,
...
SpellIcons = {
  ...
  --// New Winter Update 2022 Spells Icons
  ['iceburst']         		      = {140, 166},
  ['earthburst']         	      = {141, 167},
  ['executionersthrow']         = {142, 168},
  ['greatdeathbeam']         	  = {143, 169},
  ['divinegranade']         	  = {144, 170},
  ['cancelmagicshield']         = {145, 171},
  -- old spells
